<?php require_once('backend/connections.php');
...
<div class="list-group"> 
	<?php
		foreach ($result_type as $row )  { ?>
		 ...
		 <a href="index_member.php?act=showbytype&type_id=<?php echo $row['type_id'];?>" class="list-group-item list-group-item-action list-group-item-light"> 
