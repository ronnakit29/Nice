...
$order = $munich->Order($_GET["order_id"]);
?>
<!DOCTYPE html>
                ...
                <div class="container" style="margin-top: 50px">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4>คำสั่งซื้อเลขที่ #<?php echo $order["order"]->p_list; ?></h4>
                            <hr>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    while ($row = $order["order_list"]->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td width="150" class="text-right"><?php echo $row["odp_qty"] ?></td>
                                            <td width="150" class="text-right">฿ <?php echo number_format($row["odp_qty"] * $row["price"], 2, ".", ",") ?></td>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right">
                                            <h4>สถานะ <b><?php if ($order["order"]->order_payment_status == 0) {
                                                                echo 'รอชำระเงิน';
                                                            } else if ($order["order"]->order_payment_status == 1) {
                                                                echo 'ชำระเงินแล้ว';
                                                            } else {
