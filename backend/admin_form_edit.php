...
<input type="hidden" name="a_id" value="<?php echo  $a_id; ?>">
          <div class="form-group">
            ...
            <div class="col-sm-6" align="left">
              <input  name="a_user" type="text" required class="form-control" id="a_user" placeholder="username" pattern="^[a-zA-Z0-9]+$" title="ภาษาอังกฤษหรือตัวเลขเท่านั้น" value="<?=$a_user;?>" minlength="2"  />
            </div>
          </div>
